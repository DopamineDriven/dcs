...
const variants = {
  variant: {
    ...
    dcs_dark: "mx-auto items-center justify-center border border-transparent text-[#f0f4f8] bg-transparent ring-white ring-2 ring-inset hover:bg-[#f0f4f8] hover:bg-opacity-75 hover:text-[#102a43] z-50 transition-colors duration-150"
  },
  size: {
