      ...
      <div className='relative z-10 flex h-full w-full flex-col items-center justify-center'>
        {target === "QR" ? (
          <>
            ...
            <p className='mx-auto mb-4 max-w-xl sm:max-w-2xl text-pretty text-center font-basis-grotesque-pro-medium text-[1.25rem] leading-[1.5rem] tracking-tight text-dcs-800'>
