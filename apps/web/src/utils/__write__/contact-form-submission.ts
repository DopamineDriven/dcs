export const ContactFormSubmission = {
  submitGfForm: {
    ...
    confirmation: {
      message:
        "<div id='gform_confirmation_wrapper_1' class='gform_confirmation_wrapper '><div id='gform_confirmation_message_1' class='gform_confirmation_message_1 gform_confirmation_message'>Thanks for contacting us! We will get in touch with you shortly.</div></div>",
      pageId: null,
      queryString: null,
      type: "MESSAGE",
      url: null,
